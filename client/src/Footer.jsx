...
export default function Footer() {
  return (
    <>
      <div className="relative inset-x-0 bottom-0 bg-black dark:bg-gray-900">
        <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          <div className="md:flex md:justify-between">
            <div className="space-y-36 lg:grid lg:grid-cols-3 lg:gap-x-72 lg:space-y-0">
                ...
                <a href="/" className="flex items-center">
                  <div className=" float-right pl-14 self-center text-2xl font-semibold whitespace-nowrap text-orange-500">
                    <img
                      ...
                      alt="SwiftCart Logo"
                    />
                    <h1 className="pl-2 pt-2 pb-3">SwiftCart</h1>
                  </div>
                </a>
              ...
              {/* SECTION-2 */}
              <div>
                <h2 className="mb-6 ml-8 text-sm font-bold text-white uppercase">
                  Useful Links
                </h2>
                <ul className="text-gray-600 dark:text-gray-400 font-medium inline-block">
                  <li>
                    <Link
                      to="/"
                ...
                <ul className="inline-block ml-8">
                  <li>
                    <Link
                      to="/faqs"
                      className="text-sm font-light leading-6 text-white"
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
            <span className="pl-40 ml-96 text-center text-gray-500 dark:text-gray-400">
              SwiftCart
